  ...
  <section>
      ...
      >
        <template slot-scope="scope">
          <el-button
            ...
            v-show="roles.indexOf('01020201') >= 0"
          >查看
          </el-button>
          <el-button
            type="danger"
            ...
            v-show="roles.indexOf('01020202') >= 0"
          >上架
          </el-button>
          <el-button
            type="danger"
            ...
            v-show="roles.indexOf('01020203') >= 0"
          >修改
          </el-button>
          <el-button
            type="danger"
            ...
            v-show="roles.indexOf('01020204') >= 0"
          >删除
          </el-button>
        </template>
      </el-table-column>
    ...
    >
      <el-upload
        ...
        ref="upload"
        name="file"
        :action="uploadServer+'/jade/commodityManage/saveDoc.action?sid='+sid"
      ...
      >
        ...
        >上传到服务器</el-button>
        <a
          :href="server+'/jade/commodityManage/downExcel.action'"
          target="_blank"
          style="color: #fff;"
        >
          <el-button
        ...
        <div
          slot="tip"
          class="el-upload__tip"
        >可以上传xlsx2003和2007版本的文件但不要强制修改后缀名否则会导致版本冲突</div>
      </el-upload>
    </el-dialog>
  </section>
</template>
